            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex gap-3">
                        <a href="{{ route('login') }}" class="text-sm text-gray-700 hover:text-primary">Masuk</a>
                        <a href="{{ route('register') }}" class="text-sm text-white bg-primary px-3 py-1 rounded hover:bg-green-700">Daftar</a>
                    </div>
                @endauth
            </div>
