                ...
                <div class="p-6 space-y-3">
                    ...
                    <form method="POST" action="{{ route('admin.bookings.approve', $booking) }}" class="space-y-2">
                        ...
                        <div class="flex gap-2 mt-2">
                            <button type="submit" class="px-4 py-2 bg-primary text-white rounded hover:bg-green-700">Approve</button>
                            <button formaction="{{ route('admin.bookings.reject', $booking) }}" class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">Reject</button>
                        </div>
                    </form>
                </div>
            </div>
